...
const BettingCoupon: React.FC<BettingCouponProps> = ({ matches, initialSelections = {}, onSelectionChange }) => {
  ...
  return (
    // Adjusted padding and max-width for better responsiveness
    <div className={`w-full max-w-lg mx-auto bg-white shadow-md rounded-lg overflow-hidden ${styles.container}`}> 
      ...
      {matches.map((match: Match, index: number) => {
        ...
        return (
          ...
          <div key={matchIdStr} className="flex items-center justify-between p-3 sm:p-4 border-b border-gray-200 last:border-b-0 hover:bg-gray-50 transition-colors duration-150">

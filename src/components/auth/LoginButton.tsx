      ...
      {user ? (
        <div className="flex items-center">
          ...
          <button
            ...
            className="bg-gray-100 hover:bg-gray-200 border border-gray-300 px-3 py-2 rounded text-sm font-medium text-gray-700 transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 cursor-pointer"
          >
            Sign out
          </button>
        </div>
        ...
        <AuthModal>
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
            Sign in
          </button>
        </AuthModal>
      )}
